...
2. Ввести логин/пароль от [AeroToolKit](http://aerotoolkit.sytes.net:8000/) на [Photo Server](http://aerotoolkit.sytes.net:8001/), НАСТРОИТЬ ПАРАМЕТРЫ РАСПОЗНАВАНИЯ (!), загрузить и отправить фотографии. Локальный адрес Photo Server http://127.0.0.1:8001/ если сайт уже не работает на Yandex Cloud
