...
- В репозитории приложен Dockerfile и архив образа photo-server.tar.
  Поэтому вы можете собрать докер образ сами, если не доверяете приложенному архиву с образом.
