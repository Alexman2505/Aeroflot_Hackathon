...
3. Вернуться обратно на [AeroToolKit](http://aerotoolkit.sytes.net:8000/) и посмотреть результат работы модели компьютерного зрения. Все ссылки на сайте кликабельный, т.о. можно изучить весь список обращений к сайту, либо посмотреть отдельную запись каждого сотрудника.
