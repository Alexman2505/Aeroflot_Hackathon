...
- **Конвертация изображений** — преобразование бинарных данных для передачи по API
...
**backend/** - основной сервис с бизнес-логикой и API

**photo_server/** - клиентский сервис для загрузки изображений

**dev_ml/** - модуль для обучения и дообучения ML-моделей

Каждый сервис имеет собственные настройки Django и зависимости. Конфигурация Docker объединяет все компоненты в единую систему
